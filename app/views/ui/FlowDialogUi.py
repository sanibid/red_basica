...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.popWaterConsumptionStartLabel.setText(_translate("Dialog", "Dotación de inicio de plan (l/hab.día) [qi]"))
        self.popWaterConsumptionEndLabel.setText(_translate("Dialog", "Dotación de final de plan (l/hab.día) [qf]"))
        ...
        self.connGrowthRateLabel.setText(_translate("Dialog", "Tasa de crecimiento [Gr]"))
        self.connEconomyConnLabel.setText(_translate("Dialog", "Cantidad de economía por conexión [econ_con]"))
        self.connStartConsumptionLabel.setText(_translate("Dialog", "Dotación de inicio de plan (l/hab.día) [qi]"))
        self.connEndConsumptionLabel.setText(_translate("Dialog", "Dotación de final de plan (l/hab.día) [qf]"))
        self.connOcupancyRateStartLabel.setText(_translate("Dialog", "Tasa de ocupación inicio de plan (hab/vivienda) [Hf_Ini]"))
        self.connOcupancyRateEndLabel.setText(_translate("Dialog", "Tasa de ocupación final de plan (hab/vivienda) [Hf_Fin]"))
        self.connReturnCoefficientLabel.setText(_translate("Dialog", "Coeficiente de retorno [C]"))
        ...
        self.flowProjectionRateLabel.setText(_translate("Dialog", "Tasa de proyección [ProjRate]"))
